...
cv2.namedWindow('Color0 and Slider', cv2.WINDOW_NORMAL)
cv2.namedWindow('Color1 and Slider', cv2.WINDOW_NORMAL)
cv2.namedWindow('Color2 and Slider', cv2.WINDOW_NORMAL)
cv2.namedWindow('Color3 and Slider', cv2.WINDOW_NORMAL)
cv2.namedWindow('Color4 and Slider', cv2.WINDOW_NORMAL)
cv2.namedWindow('Color5 and Slider', cv2.WINDOW_NORMAL)
cv2.namedWindow('Color6 and Slider', cv2.WINDOW_NORMAL)
cv2.namedWindow('Color7 and Slider', cv2.WINDOW_NORMAL)
cv2.namedWindow('Color8 and Slider', cv2.WINDOW_NORMAL)
...
cv2.createTrackbar('Color0 B', 'Color0 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color0 G', 'Color0 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color0 R', 'Color0 and Slider', 127, 255, lambda x:None)

cv2.createTrackbar('Color1 B', 'Color1 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color1 G', 'Color1 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color1 R', 'Color1 and Slider', 127, 255, lambda x:None)

cv2.createTrackbar('Color2 B', 'Color2 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color2 G', 'Color2 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color2 R', 'Color2 and Slider', 127, 255, lambda x:None)

cv2.createTrackbar('Color3 B', 'Color3 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color3 G', 'Color3 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color3 R', 'Color3 and Slider', 127, 255, lambda x:None)

cv2.createTrackbar('Color4 B', 'Color4 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color4 G', 'Color4 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color4 R', 'Color4 and Slider', 127, 255, lambda x:None)

cv2.createTrackbar('Color5 B', 'Color5 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color5 G', 'Color5 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color5 R', 'Color5 and Slider', 127, 255, lambda x:None)

cv2.createTrackbar('Color6 B', 'Color6 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color6 G', 'Color6 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color6 R', 'Color6 and Slider', 127, 255, lambda x:None)

cv2.createTrackbar('Color7 B', 'Color7 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color7 G', 'Color7 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color7 R', 'Color7 and Slider', 127, 255, lambda x:None)

cv2.createTrackbar('Color8 B', 'Color8 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color8 G', 'Color8 and Slider', 127, 255, lambda x:None)
cv2.createTrackbar('Color8 R', 'Color8 and Slider', 127, 255, lambda x:None)
...
while (keypressed != 27 and keypressed !=ord('s')):
    ...
    # defines which intervals of grayscale values are for different colors using trackbar positions
    min_gs_color0 = [0,0,0]
    ...
    color0_B = cv2.getTrackbarPos('Color0 B', 'Color0 and Slider')
    color0_G = cv2.getTrackbarPos('Color0 G', 'Color0 and Slider')
    color0_R = cv2.getTrackbarPos('Color0 R', 'Color0 and Slider')
    
    color1_B = cv2.getTrackbarPos('Color1 B', 'Color1 and Slider')
    color1_G = cv2.getTrackbarPos('Color1 G', 'Color1 and Slider')
    color1_R = cv2.getTrackbarPos('Color1 R', 'Color1 and Slider')
    
    color2_B = cv2.getTrackbarPos('Color2 B', 'Color2 and Slider')
    color2_G = cv2.getTrackbarPos('Color2 G', 'Color2 and Slider')
    color2_R = cv2.getTrackbarPos('Color2 R', 'Color2 and Slider')
    
    color3_B = cv2.getTrackbarPos('Color3 B', 'Color3 and Slider')
    color3_G = cv2.getTrackbarPos('Color3 G', 'Color3 and Slider')
    color3_R = cv2.getTrackbarPos('Color3 R', 'Color3 and Slider')
    
    color4_B = cv2.getTrackbarPos('Color4 B', 'Color4 and Slider')
    color4_G = cv2.getTrackbarPos('Color4 G', 'Color4 and Slider')
    color4_R = cv2.getTrackbarPos('Color4 R', 'Color4 and Slider')
    
    color5_B = cv2.getTrackbarPos('Color5 B', 'Color5 and Slider')
    color5_G = cv2.getTrackbarPos('Color5 G', 'Color5 and Slider')
    color5_R = cv2.getTrackbarPos('Color5 R', 'Color5 and Slider')
    
    color6_B = cv2.getTrackbarPos('Color6 B', 'Color6 and Slider')
    color6_G = cv2.getTrackbarPos('Color6 G', 'Color6 and Slider')
    color6_R = cv2.getTrackbarPos('Color6 R', 'Color6 and Slider')
    
    color7_B = cv2.getTrackbarPos('Color7 B', 'Color7 and Slider')
    color7_G = cv2.getTrackbarPos('Color7 G', 'Color7 and Slider')
    color7_R = cv2.getTrackbarPos('Color7 R', 'Color7 and Slider')
    
    color8_B = cv2.getTrackbarPos('Color8 B', 'Color8 and Slider')
    color8_G = cv2.getTrackbarPos('Color8 G', 'Color8 and Slider')
    color8_R = cv2.getTrackbarPos('Color8 R', 'Color8 and Slider')
    ...
    cv2.imshow('Color0 and Slider', color0parts)
    cv2.imshow('Color1 and Slider', color1parts)
    cv2.imshow('Color2 and Slider', color2parts)
    cv2.imshow('Color3 and Slider', color3parts)
    cv2.imshow('Color4 and Slider', color4parts)
    cv2.imshow('Color5 and Slider', color5parts)
    cv2.imshow('Color6 and Slider', color6parts)
    cv2.imshow('Color7 and Slider', color7parts)
    cv2.imshow('Color7 and Slider', color8parts)
...
if keypressed == 27:
    cv2.destroyAllWindows()
     ...
     cv2.imwrite('custom image',custom_img)
