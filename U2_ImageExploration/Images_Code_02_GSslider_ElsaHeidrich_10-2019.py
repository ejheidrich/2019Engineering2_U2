...
#colors the paper with BGR values
color0_paper[0:imgH, 0:imgW, 0:imgC] = [0,255,2]
color1_paper[0:imgH, 0:imgW, 0:imgC] = [255,0,0]
color2_paper[0:imgH, 0:imgW, 0:imgC] = [0,0,255]
